        ...
        <div class="col-9 p-5">
            <div class="d-flex justify-content-between align-items-baseline">
                <div class="d-flex align-items-center p-b4">
                    ...
                    <follow-button user-id="{{ $userid->id }}" follows="{{ $follows }}"></follow-button>
                </div>
            ...
            <div class="d-flex">
                ...
                <div class="pr-5"><strong>{{ $userid->profile->followers->count() }}</strong> followers</div>
                <div class="pr-5"><strong>{{ $userid->following->count() }}</strong> following</div>
            </div>
